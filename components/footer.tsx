...
export function Footer() {
  return (
    <footer className="brand-surface-navy text-white">
          ...
          <div>
            ...
            <ul className="flex flex-col gap-3.5">
              ...
              <li className="flex items-center gap-3 text-sm text-white/55">
                ...
                <a href="mailto:info@foodjutters.nl" className="hover:text-primary transition-colors">
                  info@foodjutters.nl
                </a>
              </li>
            </ul>
      ...
      {/* Bottom bar — één horizontale lijn */}
      <div className="border-t border-white/8">
        <div className="relative max-w-6xl mx-auto px-6 py-4 flex items-center justify-between gap-4 text-xs min-h-[2.5rem]">
          <p className="text-white/35 shrink-0">
            &copy; {new Date().getFullYear()}{' '}
            <BrandName className="text-inherit tracking-normal" variant="light" />. Alle rechten
            voorbehouden.
          </p>
          <p className="absolute left-1/2 -translate-x-1/2 text-white/35 whitespace-nowrap pointer-events-auto">
            Gerealiseerd door{' '}
            <a
          ...
          <div className="flex shrink-0 gap-5 ml-auto">
