...
export default function HomePage() {
  return (
    <>
      ...
      {/* ── Opening banner ──────────────────────────── */}
      <section className="bg-white py-8 md:py-10 px-6 text-brand-navy border-b border-border/60">
        ...
        <div className="relative max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start mb-14 md:mb-16">
            ...
            <div className="grid grid-cols-2 gap-3 md:gap-4">
              ...
              <div className="col-span-2 rounded-2xl bg-wood-muted p-5 md:p-6 flex items-center justify-between gap-4 border border-primary/15">
                <div>
